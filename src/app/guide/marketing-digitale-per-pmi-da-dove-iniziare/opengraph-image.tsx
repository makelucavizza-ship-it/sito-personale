...
export const alt = "Marketing Digitale per PMI: Da Dove Iniziare | Luca Vizza";
...
export default function OGImage() {
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ fontSize: 16, color: "#ffbd59", fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "20px" }}>
        Marketing
      </div>
      ...
      <div style={{ fontSize: 22, color: "#f5f0ebaa", lineHeight: 1.4 }}>
        La sequenza giusta: prima automatizza i processi, poi porta traffico
      </div>
