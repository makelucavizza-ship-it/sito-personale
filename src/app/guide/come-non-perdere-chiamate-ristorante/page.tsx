...
export const metadata: Metadata = {
  ...
  description:
    "Quante prenotazioni perde un ristorante durante il servizio? Soluzioni concrete in ordine di costo e complessità: segreteria, risponditore, agente vocale AI. Guida pratica per ristoratori.",
  alternates: {
