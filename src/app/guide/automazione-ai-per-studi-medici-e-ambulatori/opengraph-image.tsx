...
export const alt = "Automazione AI per Studi Medici e Ambulatori | Luca Vizza";
...
export default function OGImage() {
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ fontSize: 16, color: "#5bc783", fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "20px" }}>
        Sanità e benessere
      </div>
      ...
      <div style={{ fontSize: 22, color: "#f5f0ebaa", lineHeight: 1.4 }}>
        Appuntamenti, reminder e GDPR — guida pratica
      </div>
