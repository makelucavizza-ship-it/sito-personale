...
export const metadata: Metadata = {
  ...
  description:
    "Cos'è un agente vocale AI, come risponde al telefono al posto tuo, come si integra con il numero esistente e in quali settori ha davvero senso usarlo. Guida senza tecnicismi.",
  alternates: {
