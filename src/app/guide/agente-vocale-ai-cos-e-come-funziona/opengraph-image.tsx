...
export const alt = "Agente vocale AI: cos'è e come funziona";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ fontSize: 20, color: "#3ad3ef", fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", marginBottom: 24 }}>
          Guida
        </div>
